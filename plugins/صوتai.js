...
if (!text) throw `*${lenguajeGB['smsAvisoMG']()}اقتراح قائمة من أوامر وأوامر مفيدة: ❏ ${usedPrefix + command} اقتراح عشرة أفلام اكشن ❏ ${usedPrefix + command} كود جافا سكريبت للعبة حجر ورقه مقص  ${usedPrefix + command} كود جافا سكريبت ل` 
try {
...
handler.command = /^(صوتai|chatgptvoz|iavoz|robotvoz|openai2voz|chatgpt2voz|ia2voz|robot2voz|Lolivoz|LoliBotvoz|gptvoz|ai_voz|ai_voce)$/i;
